...
class siswaController extends Controller
{
    ...
    public function siakad_index(Request $request)
    {
        ...
        return view('siakad.admin.siswa.index',compact('pages','jmldata','datas','tapel','kelas','request'));
        // return view('admin.beranda');
    }
    ...
    public function store(Request $request)
    {
       ...
       DB::table('users')->insert(
        ...
        return redirect()->back()->with('status','Data berhasil diupdate!')->with('tipe','success')->with('icon','fas fa-feather');
    ...
    public function siakad_show(Request $request,siswa $siswa)
    {
        #WAJIB
        $pages='siakadsiswa';
        $jmldata='0';
        ...
        return view('siakad.admin.siswa.edit',compact('pages','jmldata','datas','tapel','kelas','siswa','datausers','request'));
    }
    ...
    public function proses_update($request,$siswa)
    {
        // dd($siswa->nis);
        $datausers = DB::table('users')->where('nomerinduk',$siswa->nis)->get();
...
if($this->checkauth('admin')==='success'){
    ...
    {
        $this->proses_update($request,$siswa);

            return redirect(URL::to('/').'/admin/siswa')->with('status','Data berhasil diupdate!')->with('tipe','success')->with('icon','fas fa-edit');
    }

    public function siakad_update(Request $request, siswa $siswa)
    {
        $this->proses_update($request,$siswa);
            return redirect(URL::to('/').'/admin/siakadsiswa')->with('status','Data berhasil diupdate!')->with('tipe','success')->with('icon','fas fa-edit');
    }
//     public function update2(Request $request, siswa $siswa)
//     { 
//         // dd($siswa->nis);
//         $datausers = DB::table('users')->where('nomerinduk',$siswa->nis)->get();
//         foreach($datausers as $d){
