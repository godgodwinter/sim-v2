...
<tr id="sid{{ $data->nis }}">
    ...
    <td>
        ...
        <img alt="image" src="{{ asset("storage/") }}/{{ $profile_photo_path }}" class="rounded mx-auto d-block"
            width="50px" height="50px" style="overflow: auto;">
        @else
        <img alt="image" src="https://ui-avatars.com/api/?name={{ $data->nama }}&color=7F9CF5&background=EBF4FF"
            class="rounded mx-auto d-block" width="50px" height="50px">
                ...
                <div class="row">
                    <div class="form-group col-md-2 col-2 text-right">
                        <input type="text" name="cari" id="cari"
                            class="form-control form-control-md @error('cari') is-invalid @enderror"
        ...
        <div class="card">
            ...
            <div id="babeng-bar" class="text-center mt-2">
                ...
                <div id="babeng-row ">
                    ...
                    <form action="{{ route('settings.resetsiswa.cari') }}" method="GET">
                        <input type="text" name="cari" id="cari"
                            class="babeng babeng-select  ml-2 @error('cari') is-invalid @enderror"
                            value="{{$request->cari}}" placeholder="Cari...">
                        @error('cari')<div class="invalid-feedback"> {{$message}}</div>
                        @enderror
                        ...
                        <a href="{{ route('settings.resetsemua') }}"
                            class="btn btn-icon btn-primary btn-sm ml-0 ml-sm-4"
                            onclick="return  confirm('Anda yakin mereset semua password login siswa? Y/N')"
                            data-toggle="tooltip" data-placement="top"
                            title="Untuk mereset semua password login siswa!"><span class="pcoded-micon"> <i
                                    class="fas fa-redo"></i> Reset Semua Siswa</span></a>
