                    ...
                    <form action="{{ route('passwordujian.generate') }}" method="post" class="d-inline ml-5">
                        ...
                        <div class="card-footer text-right">
                            <button class="btn btn-danger "
                                onclick="return  confirm('Anda yakin melakukan generate Password Ujian? Y/N')"
                                data-toggle="tooltip" data-placement="top"
                                title="Untuk mengembalikan pengaturan website ke pengaturan default! Data Informasi aplikasi dan sekolah juga direset.">
