  ...
  @endphp
    <td class="text-center">
      ...
      @endphp
        ...
        <br>
        <a href="{{ url('/admin/inputnilai/kelas') }}/{{ $dk->id }}"  type="button" class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Input nilai Kepribadian"><i class="fas fa-ribbon"></i></a>
    </td>
  @endforeach
</tr>
@endforeach
