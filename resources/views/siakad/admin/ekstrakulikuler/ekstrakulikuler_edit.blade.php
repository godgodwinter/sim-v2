  ...
  <div class="section-body">
    <div class="row mt-sm-4">
      ...
      <div class="col-12 col-md-6 col-lgid-7">
        <div class="card">
          <form action="/admin/{{ $pages }}/{{$ekstrakulikuler->id}}" method="post">
              @method('put')
              @csrf
            ...
            <div class="card-body">
                <div class="row">
                  <div class="form-group col-md-12 col-12">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="X IPA 1" value="{{ $ekstrakulikuler->nama }}" required>
