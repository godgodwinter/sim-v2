    ...
    <div class="section-body">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{route('tagihan.update',$id->id)}}" method="post">
                    @method('put')
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 col-5 mt-0 ml-5">
                            ...
                            <input type="text" name="total" id="total" class="form-control @error('total') is-invalid @enderror" value="{{old('total')?old('total'):Fungsi::rupiah($id->total)}}" required>
