                    ...
                    <tbody>
                        ...
                        <tr id="sid{{ $data->id }}">
                                ...
                                <td class="text-center babeng-min-row">
                                    ...
                                    <a href="{{route('guru.penilaian.inputnilai',$data->id)}}" type="button" class="btn btn-outline-info btn-sm" data-toggle="tooltip" data-placement="top" title="Input Nilai Siswa!" >
